...
def select_store(page, bip_name: str):
    ...
    active_now = open_store_dropdown(page)
    print(f"  Loja ativa atual: {active_now} | Selecionando: {bip_name}")

    last_error = None

    for attempt in range(1, 4):
        print(f"  Tentativa {attempt}/3 de selecionar loja...")
        ...
        save_debug(page, f"select_attempt_{attempt}_{slug(bip_name)}")
        time.sleep(2)
